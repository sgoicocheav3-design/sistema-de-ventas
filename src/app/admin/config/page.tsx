                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" value={config.nombre_comercial}
                      ...
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="Ej: Mi Minimarket" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Razón Social</label>
                    <input type="text" value={config.razon_social}
                      onChange={(e) => update('razon_social', e.target.value)}
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="Ej: Mi Empresa SAC" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">RUC</label>
                    <input type="text" value={config.ruc}
                      onChange={(e) => update('ruc', e.target.value)}
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="20XXXXXXXXX" maxLength={11} />
                  </div>
                  <div>
                    ...
                    <input type="text" value={config.direccion_fiscal}
                      ...
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="Dirección registrada en SUNAT" />
                  </div>
                  <div>
                    ...
                    <input type="text" value={config.direccion_establecimiento}
                      ...
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="Dirección del local" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Teléfono</label>
                    <input type="text" value={config.telefono}
                      onChange={(e) => update('telefono', e.target.value)}
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="Ej: 987654321" />
                  </div>
                  <div className="sm:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-1">Correo Electrónico</label>
                    <input type="email" value={config.correo}
                      onChange={(e) => update('correo', e.target.value)}
                      className="w-full px-3 py-2.5 border rounded-lg outline-none" placeholder="Ej: contacto@minimarket.com" />
                  </div>
                </div>
              </div>
